...
Na brak odpowiednio dobrego wyniku mogły złożyć się przede wszystkim elementy związane z danymi, ich liczbą oraz przygotowaniem. Danych zawieracjących głosy nietoperzy była zdecydowana mniejszość spośród całego zbioru danych. Większość stanowiły szumy oraz dźwięki niezidentyfikowane, które mogły zawierać głosy nietoperzy bądź nie. Liczba nagrań samych nietoperzy wyniosła jedynie 2 347. Większość gatunków była też bardzo nielicznie reprezentowana. Dodatkowo w ręcznej analzie wykrywano nagrania, w których znajdował się więcej niż jeden gatunek. Inne czynniki związane z danymi, które mogły wpłynąć na zły wynik były np. brak usunięcia ciszy z nagrań przed przycięciem, co mogło skutkować występowaniem ciszy w pozostałych przyciętych 2-sekundowych odcinkach nagrania, a co za tym idzie zidentyfikowaniem ciszy i szumów jako konkretnego gatunku.
...
Na Rysunku \ref{img:dpu} przedstawiono diagram przypadków użycia wizualizujący czynności, które mogą w systemie wykonać użytkownicy.

\begin{figure}[h]
  \centering
  \includegraphics[width=0.9\textwidth]{sprz/dpu.jpg}
...
\begin{enumerate}
  \item Niniejsza praca dyplomowa w formacie PDF
