...
\begin{enumerate}[label=\textbf{\arabic*}.]
  \item \textbf{Opis problemu}
    ...
    Głównym udziałowcem i zarazem pomysłodawcą jest firma BIOSECO, której przedstawicielami są dr Dawid Gradolewski oraz dr Damian Dziak. Udziałowcami produktu, który może zostać wytworzony na dalszym etapie na bazie projektu inżynierskiego, są inwestorzy przygotowujący farmy wiatrowe w Polsce i na świecie, takie jak PGE, Energa, RWE, Polenergia, Iberdrola itd., a także twórcy monitoringów chiropterologicznych, Regionalne i Generalna Dyrekcja Ochrony Środowiska - posiadający tę opcję działań minimalizujących w swoim w arsenale.
    ...
    \begin{enumerate}[font=\bfseries]
      ...
      \item \textbf{Interfejs z otoczeniem}
        ...
        \begin{requirementstab}[label={tab:requirements:func1},caption={Liczba i lokalizacja mikrofonów na turbinie}]
          \id{WF02}
          \priority{M}
          \name{Liczba i lokalizacja mikrofonów na turbinie}
          \descr{Plan liczby i lokalizacji mikrofonów ultradźwięków na turbinie wiatrowej tak, aby system pewłnił funkcje ochrony nietoperzy}
          \acceptcrit{Realizacja testów terenowych mikrofonu}
          \inputdata{Mikrofon ultradźwięków}
          \postconditions{Pokrycie kąte 360\textdegree przez rejestrację ultradźwękową}
          \implementation{}
          \sholder{UOP 01, UNB 01}
          \reqrelated{}
        \end{requirementstab}
